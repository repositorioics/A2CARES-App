...
import ni.org.ics.a2cares.app.ui.forms.ReconsentimientoForm;
import ni.org.ics.a2cares.app.ui.forms.TamizajeFormLabels;
import ni.org.ics.a2cares.app.ui.forms.ReconsentimientoFormLabels;
import ni.org.ics.a2cares.app.utils.CalcularEdad;
...
public class NuevoReconsentimientoActivity extends AbstractAsyncActivity implements
    ...
    private ReconsentimientoFormLabels labels = new ReconsentimientoFormLabels();
    ...
    private static Participante participante1 = new Participante();
    private Casa casa;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        participante1 = (Participante) getIntent().getExtras().getSerializable(Constants.PARTICIPANTE);
        ...
        username =
                settings.getString(PreferencesActivity.KEY_USERNAME,
                        null);
        infoMovil = new DeviceInfo(NuevoReconsentimientoActivity.this);
        ...
        mWizardModel = new ReconsentimientoForm(this,mPass);
    ...
    public void updateModel(Page page){
        try{
            ...
            String sexo = null;
           // sexo = participante1.getSexo();
            Date fechaNacimiento = null;
            DateFormat mDateFormat1 = new SimpleDateFormat("dd/MM/yyyy");
           // fechaNacimiento = mDateFormat1.parse("1208412000");
    ...
    public void saveData() {
        try {
            ...
            try {
                ...
                fechaNacimiento = participante1.getFechaNac();
            } catch (ParseException e) {
                e.printStackTrace();
            ...
            if (existeParti == null || existeParti.getCodigo() == null) {
                ...
                Tamizaje tamizaje = new Tamizaje();
             //   estudiosAdapter.editarTamizaje(tamizaje);
               ...
               // estudiosAdapter.editarTamizaje(tamizaje);
                ...
                if (tamizaje.getAceptaTamizajePersona().equals(Constants.YESKEYSND)) {
                    ...
                    if (tieneValor(aceptaParticipar) && aceptaParticipar.equalsIgnoreCase(Constants.YES)) {
                        ...
                        if (tieneValor(participante1.getNombre1Tutor())) {
                            cc.setNombre1Tutor(participante1.getNombre1Tutor());
                        } else if (edadAnios >= 18) { //si es mayor de edad, seteas los datos del propio participante como tutor
                            cc.setNombre1Tutor(participante1.getNombre1Tutor());
                        }
                        if (tieneValor(participante1.getNombre2Tutor())) {
                            cc.setNombre2Tutor(participante1.getNombre2Tutor());
                        } else if (edadAnios >= 18) { //si es mayor de edad, seteas los datos del propio participante como tutor
                            cc.setNombre2Tutor(participante1.getNombre2Tutor());
                        }
                        if (tieneValor(participante1.getApellido1Tutor())) {
                            cc.setApellido1Tutor(participante1.getApellido1Tutor());
                        } else if (edadAnios >= 18) { //si es mayor de edad, seteas los datos del propio participante como tutor
                            cc.setApellido1Tutor(participante1.getApellido1Tutor());
                        }
                        if (tieneValor(participante1.getApellido2Tutor())) {
                            cc.setApellido2Tutor(participante1.getApellido2Tutor());
                        } else if (edadAnios >= 18) { //si es mayor de edad, seteas los datos del propio participante como tutor
                            cc.setApellido2Tutor(participante1.getApellido1Tutor());
                        }

                        if (tieneValor(participante1.getRelacionFamiliarTutor())) {
                            MessageResource catRelacionFamiliarTutor = estudiosAdapter.getMessageResource(MainDBConstants.spanish + "='" + participante1.getRelacionFamiliarTutor() + "' and " + MainDBConstants.catRoot + "='CAT_RF_TUTOR'", null);
                        ...
                        if (tieneValor(codigoCasaCohorte)) {
                            ...
                            casa.setNombre1JefeFamilia(participante1.getCasa().getNombre1JefeFamilia());
                            casa.setNombre2JefeFamilia(participante1.getCasa().getNombre2JefeFamilia());
                            casa.setApellido1JefeFamilia(participante1.getCasa().getApellido1JefeFamilia());
                            casa.setApellido2JefeFamilia(participante1.getCasa().getApellido2JefeFamilia());
                        ...
                        //crear participante
                        participante.setCodigo(participante1.getCodigo());
                        if (tieneValor(participante1.getNombre1())) participante.setNombre1(participante1.getNombre1());
                        if (tieneValor(participante1.getNombre2())) participante.setNombre2(participante1.getNombre2());
                        if (tieneValor(participante1.getApellido1())) participante.setApellido1(participante1.getApellido1());
                        if (tieneValor(participante1.getApellido2())) participante.setApellido2(participante1.getApellido2());
                        if (tieneValor(nombre1Padre)) {
                            if (tieneValor(participante1.getNombre1Padre()))
                                participante.setNombre1Padre(participante1.getNombre1Padre());
                            if (tieneValor(participante1.getNombre2Padre()))
                                participante.setNombre2Padre(participante1.getNombre2Padre());
                            if (tieneValor(participante1.getApellido1Padre()))
                                participante.setApellido1Padre(participante1.getApellido1Padre());
                            if (tieneValor(participante1.getApellido2Padre()))
                                participante.setApellido2Padre(participante1.getApellido2Padre());
                        } else {
                        ...
                        if (tieneValor(participante1.getNombre1Madre())) {
                            if (tieneValor(participante1.getNombre1Madre()))
                                participante.setNombre1Madre(participante1.getNombre1Madre());
                            if (tieneValor(participante1.getNombre2Madre()))
                                participante.setNombre2Madre(participante1.getNombre2Madre());
                            if (tieneValor(participante1.getApellido1Madre()))
                                participante.setApellido1Madre(participante1.getApellido1Madre());
                            if (tieneValor(participante1.getApellido2Madre()))
                                participante.setApellido2Madre(participante1.getApellido2Madre());
                        } else {
                     ...
                     /*   if (tieneValor(sexo)) {
                        ...
                        if (tieneValor(participante1.getNombre1Tutor())) {
                            participante.setNombre1Tutor(participante1.getNombre1Tutor());
                        }
                        if (tieneValor(participante1.getNombre2Tutor())) {
                            participante.setNombre2Tutor(participante1.getNombre2Tutor());
                        }
                        if (tieneValor(participante1.getApellido1Tutor())) {
                            participante.setApellido1Tutor(participante1.getApellido1Tutor());
                        }
                        if (tieneValor(participante1.getApellido2Tutor())) {
                            participante.setApellido2Tutor(participante1.getApellido2Tutor());
                        }
                        if (tieneValor(participante1.getRelacionFamiliarTutor())) {
                            MessageResource catRelacionFamiliarTutor = estudiosAdapter.getMessageResource(MainDBConstants.spanish + "='" + participante1.getRelacionFamiliarTutor() + "' and " + MainDBConstants.catRoot + "='CAT_RF_TUTOR'", null);
                            if (catRelacionFamiliarTutor != null)
                            ...
                            participante.setNombre1Tutor(participante1.getNombre1());
                            participante.setNombre2Tutor(participante1.getNombre2());
                            participante.setApellido1Tutor(participante1.getApellido1());
                            participante.setApellido2Tutor(participante1.getApellido2());
                        }
                        //meta data
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setPositiveButton(R.string.submit_confirm_button,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ((NuevoReconsentimientoActivity) Objects.requireNonNull(getActivity())).saveData();
                                }
                            }
                    )
                    .setNegativeButton(R.string.cancel,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ((NuevoReconsentimientoActivity) Objects.requireNonNull(getActivity())).createDialog(EXIT);;
                                }
                            }
                    )
                    .create();
