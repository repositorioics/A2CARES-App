...
public class RecepcionBhcActivity extends AbstractAsyncActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        infoMovil = new DeviceInfo(RecepcionBhcActivity.this);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(validarEntrada()){
                    ...
                    recepcionMuestra.setTipoTubo(Constants.TIPO_TUBO_BHC);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case MENU_VIEW:
                ...
                i.putExtra(Constants.TIPO_TUBO, Constants.TIPO_TUBO_BHC);
                startActivity(i);
                return true;
            default:
