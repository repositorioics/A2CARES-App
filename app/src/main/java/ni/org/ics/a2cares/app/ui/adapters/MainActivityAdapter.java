	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		switch (position){
			...
			case 5:
				...
				break;
			case 6:
				img=getContext().getResources().getDrawable(R.mipmap.ic_supervisor);
				textView.setCompoundDrawablesWithIntrinsicBounds(null, img, null, null);
				break;
			case 7:
				img=getContext().getResources().getDrawable(R.mipmap.ic_laboratory);
				textView.setCompoundDrawablesWithIntrinsicBounds(null, img, null, null);
				break;
			case 8:
				img=getContext().getResources().getDrawable(R.mipmap.ic_gps_candidates);
				textView.setCompoundDrawablesWithIntrinsicBounds(null, img, null, null);
				break;
			case 9:
				img=getContext().getResources().getDrawable(R.mipmap.ic_doctor);
				textView.setCompoundDrawablesWithIntrinsicBounds(null, img, null, null);
				break;
			case 10:
			...
			case 11:
				...
				break;
			case 12:
				img=getContext().getResources().getDrawable(R.mipmap.ic_admision1);
				textView.setCompoundDrawablesWithIntrinsicBounds(null, img, null, null);
				break;
			case 13:
