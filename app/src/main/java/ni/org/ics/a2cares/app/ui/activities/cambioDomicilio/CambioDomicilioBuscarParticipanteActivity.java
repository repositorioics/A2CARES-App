...
import ni.org.ics.a2cares.app.ui.adapters.CambioDomicilioParticipanteListAdapter;
import ni.org.ics.a2cares.app.ui.adapters.ParticipanteListAdapter;
import ni.org.ics.a2cares.app.utils.Constants;

public class CambioDomicilioBuscarParticipanteActivity extends AbstractAsyncActivity {
    ...
    private CambioDomicilioParticipanteListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CambioDomicilioBuscarParticipanteActivity.FetchCambioDomicilioDataTask().execute();
    }
            ...
            if (codigoScanned != null && codigoScanned.length() > 0) {
                ...
                try{
                    ...
                    if (mParticipante!= null && mParticipante.getCodigo() != null){
                        ...
                        //}
                        showToast("Cargar la nueva pantalla");
    ...
    public void buscarParticipante(String parametro, int opcion){
        ...
        new CambioDomicilioBuscarParticipanteActivity.FetchCambioDomicilioParticipantsTask().execute(filtro);
    }
    ...
    // Private classes
    // ***************************************
    private class FetchCambioDomicilioParticipantsTask extends AsyncTask<String, Void, String> {
    ...
    private class FetchCambioDomicilioDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String resultado) {
            adapter = new CambioDomicilioParticipanteListAdapter(mParticipantes, mUser.getVisitas(), desdeMedico, desdeLaboratorio);
            recyclerView.setAdapter(adapter);
            dismissProgressDialog();
        }
    }
