...
public class CambioDomicilioCasaListAdapter extends RecyclerView.Adapter<CambioDomicilioCasaListAdapter.ViewHolder> {
    ...
    public CambioDomicilioCasaListAdapter(List<Casa> listdata, boolean nuevoIngreso, Activity activity) {
    ...
    @Override
    public CambioDomicilioCasaListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.complex_list_item, parent, false);
        CambioDomicilioCasaListAdapter.ViewHolder viewHolder = new CambioDomicilioCasaListAdapter.ViewHolder(listItem) {
        };
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(CambioDomicilioCasaListAdapter.ViewHolder holder, int position) {
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(holder.context,"Cargar la nueva pantalla",Toast.LENGTH_SHORT).show();
            }
        });
    }
