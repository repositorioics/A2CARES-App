...
public class CambioDomicilioMainActivityAdapter extends ArrayAdapter<String> {
    private final String[] values;
    public CambioDomicilioMainActivityAdapter(Context context, int textViewResourceId,
                                              String[] values) {
