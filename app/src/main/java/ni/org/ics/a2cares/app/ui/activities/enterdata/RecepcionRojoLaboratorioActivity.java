 ...
 */
public class RecepcionRojoLaboratorioActivity extends AbstractAsyncActivity {

    protected static final String TAG = RecepcionRojoLaboratorioActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recepcion_rojo_laboratorio);
        ...
        infoMovil = new DeviceInfo(RecepcionRojoLaboratorioActivity.this);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(validarEntrada()){
                    ...
                    serologia.setIdSerologia(null);//no se setea porque es autoincrement en la base de datos del server
                    serologia.setParticipante(codigo);
                    ...
                    serologia.setDeviceid(infoMovil.getDeviceId());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case MENU_VIEW:
                i = new Intent(getApplicationContext(),
                        ListaRecepcionesLaboratorioActivity.class);
