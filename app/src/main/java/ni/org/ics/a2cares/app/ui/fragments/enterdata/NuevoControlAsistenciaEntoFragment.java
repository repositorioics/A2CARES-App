 ...
 */
public class NuevoControlAsistenciaEntoFragment extends Fragment {
    ...
    public static NuevoControlAsistenciaEntoFragment create(String key) {
        NuevoControlAsistenciaEntoFragment fragment = new NuevoControlAsistenciaEntoFragment();
        Bundle args = new Bundle();
        args.putString(ARG_KEY, key);

        NuevoControlAsistenciaEntoFragment f = new NuevoControlAsistenciaEntoFragment();
        f.setArguments(args);
    ...
    public NuevoControlAsistenciaEntoFragment() {}
