...
public abstract class AbstractWizardModel implements ModelCallbacks {
    ...
    public Map<String,String> getAnswers() {
        Map<String, String> mapa = new HashMap<String, String>(getCurrentPageSequence().size());
        for (Page page : getCurrentPageSequence()) {
        	mapa.put(page.getKey(), page.getData().get(Page.SIMPLE_DATA_KEY)!=null ? page.getData().get(Page.SIMPLE_DATA_KEY).toString():null);
        }
        return mapa;
    }
