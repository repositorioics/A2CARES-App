...
public class CuestionarioHogarForm extends AbstractWizardModel {
    ...
    protected PageList onNewRootPageList() {
        ...
        Page temperaturaPERI = new NumberPage(this,labels.getTemperaturaPERI(),"C°", Constants.WIZARD, true).setRangeValidation(true, 20, 48).setRequired(true);
       ...
       // Page hayAmbienteINTRA = new SingleFixedChoicePage(this,labels.getHayAmbienteINTRA(),"", Constants.WIZARD, true).setChoices(catSiNo).setRequired(true);
        ...
        Page temperaturaINTRA = new NumberPage(this,labels.getTemperaturaINTRA(),"C°", Constants.WIZARD, true).setRangeValidation(true, 20, 48).setRequired(true);
