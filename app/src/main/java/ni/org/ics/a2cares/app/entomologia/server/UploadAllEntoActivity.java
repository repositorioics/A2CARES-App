...
package ni.org.ics.a2cares.app.entomologia.server;
...
import ni.org.ics.a2cares.app.entomologia.server.task.UploadAllEntoTask;
...
public class UploadAllEntoActivity extends Activity implements UploadListener{

	protected static final String TAG = UploadAllEntoActivity.class.getSimpleName();

	private String username;
	private String password;
	private String url;
	private SharedPreferences settings;
	private UploadAllEntoTask uploadAllTask;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		uploadAllTask = (UploadAllEntoTask) getLastNonConfigurationInstance();
	...
	private void uploadAll() {
		uploadAllTask =  new UploadAllEntoTask(this.getApplicationContext());
		uploadAllTask.setUploadListener(UploadAllEntoActivity.this);
