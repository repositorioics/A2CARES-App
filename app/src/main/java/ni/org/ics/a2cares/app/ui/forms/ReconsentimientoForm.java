...
public class ReconsentimientoForm extends AbstractWizardModel {

	int index = 0;
	private ReconsentimientoFormLabels labels;
    ...
    public ReconsentimientoForm(Context context, String pass) {
        super(context,pass);
    }
    ...
    protected PageList onNewRootPageList() {
    	...
    	labels = new ReconsentimientoFormLabels();
      ...
      // Page sexo = new SingleFixedChoicePage(this,labels.getSexo(), labels.getSexoHint(), Constants.WIZARD, true).setChoices(catSexo).setRequired(false);


	   Page fechaNacimiento = new NewDatePage(this,labels.getFechaNacimiento(), labels.getFechaNacimientoHint(), Constants.WIZARD, true).setRangeValidation(true, dmDesde, dmHasta).setRequired(false);
...
*/
      ...
      //  Page ubicacion = new MapaBarriosPage(this, labels.getCoordenadas(), "", Constants.WIZARD, true).setRequired(true);
       ...
       // Page codigoNuevoParticipante = new BarcodePage(this,labels.getCodigoNuevoParticipante(),"",Constants.WIZARD, false).setPatternValidation(true, "^\\d{4}$").setRequired(true);
		...
		return new PageList( fechaNacimiento,edad,aceptaTamizaje, razonNoAceptaTamizaje, otraRazonNoAceptaTamizaje,
                ...
                casaPerteneceCohorte, codigoCasaCohorte, codigoNuevaCasaCohorte, nombre1JefeFamilia, nombre2JefeFamilia, apellido1JefeFamilia, apellido2JefeFamilia, barrio, direccion, nombre1, nombre2, apellido1, apellido2,
	...
	public ReconsentimientoFormLabels getLabels() {
		return labels;
	}

	public void setLabels(ReconsentimientoFormLabels labels) {
		this.labels = labels;
	}
