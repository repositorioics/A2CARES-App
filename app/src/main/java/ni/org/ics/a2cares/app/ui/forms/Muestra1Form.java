 ...
 */
public class Muestra1Form extends AbstractWizardModel {
    ...
    public Muestra1Form(Context context, String pass) {
        super(context, pass);
    }
    ...
    protected PageList onNewRootPageList() {
       ...
       // Page volumen1 = new LabelPage(this, "<font color='red'>"+labels1.getVolumenRojoSugerido()+ "</font>", "", Constants.WIZARD, false).setRequired(true);
        ...
        Page razonNoRojo1 = new SingleFixedChoicePage(this, labels1.getRazonNoRojo(), "", Constants.WIZARD, false).setChoices(catSinMuestra).setRequired(true);
        Page otraRazonNoRojo1= new TextPage(this,labels1.getOtraRazonNoRojo(),"", Constants.WIZARD, false).setRequired(true);
        ...
        Page razonNoBHC1 = new SingleFixedChoicePage(this, labels1.getRazonNoBHC(), "", Constants.WIZARD, false).setChoices(catSinMuestra).setRequired(true);
        Page otraRazonNoBHC1 = new TextPage(this,labels1.getOtraRazonNoBHC(),"", Constants.WIZARD, false).setRequired(true);
       ...
       // return new PageList(tuboRojo, codigoRojo, volumenRojo, razonNoRojo, otraRazonNoRojo, tuboBHC, codigoBHC, volumenBHC, razonNoBHC, otraRazonNoBHC, pinchazos, observacion, descOtraObservacion);
        return new PageList(volumen1.setRequired(false),tuboRojo1, codigoRojo1, volumenRojo1, razonNoRojo1, otraRazonNoRojo1, tuboBHC1, codigoBHC1, volumenBHC1, razonNoBHC1, otraRazonNoBHC1, pinchazos, observacion, descOtraObservacion);
